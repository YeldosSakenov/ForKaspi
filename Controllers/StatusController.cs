...
namespace IdeaBank.Web.Controllers
{
    public class StatusController : BaseController
    {
        ...
        [Authorize(Roles = "Admin")]
        [HttpPost]
        public async Task<ActionResult> Create(StatusDto value)
        {
            try
            {
        ...
        public async Task<ActionResult> EditType(StatusDto value)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        [Authorize(Roles = "Admin")]
        [HandleError]
        public async Task<ActionResult> Delete(StatusDto value)
        {
            try
            {
                if (ModelState.IsValid)
