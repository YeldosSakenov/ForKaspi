        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _iAspNetUserRoles = new AspNetUserRoles();
                    await _iAspNetUserRoles.Create(new Core.Dtos.AspNetUserRolesDto { UserId= user .Id, RoleId= "8bd8e08a-61d4-41b3-b250-cda0be0939ec" });
